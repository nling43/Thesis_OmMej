...
import IconFrequencyQuestion from "../../Icon/IconQuestion/IconFrequencyQuestion";
...
const Node = styled.div`
  ...
  color: ${(props) => props.theme.questionTextFrequency};
  border: 2px solid
    ${(props) =>
